...
$login_required = ['edit_profile', 'transaction', 'transaction_list', 'review'];
...
<head>
    ...
    <style>
        * {
        ...
        #rating-1-review:checked~.emoji-wrapper>.emoji {
            transform: translateY(-100px);
        }

        #rating-2-review:checked~.emoji-wrapper>.emoji {
            transform: translateY(-200px);
        }

        #rating-3-review:checked~.emoji-wrapper>.emoji {
            transform: translateY(-300px);
        }

        #rating-4-review:checked~.emoji-wrapper>.emoji {
            transform: translateY(-400px);
        }

        #rating-5-review:checked~.emoji-wrapper>.emoji {
            transform: translateY(-500px);
        }
