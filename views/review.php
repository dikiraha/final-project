...
?>
<?php if ($session_id == $booking['user_id']): ?>
    <div class="container-fluid car pb-5">
        <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 800px;">
            <h1 class="display-5 text-capitalize">Ulasan <span class="text-primary">Penyewaan</span></h1>
        </div>
        ...
        <div class="row pt-3 wow fadeInUp" data-wow-delay="0.1s">
            <form action="backend/booking/review.php" method="POST">
                <div class="modal-body">
                    <input type="hidden" name="uuid" id="reviewUuid" value="<?php echo htmlspecialchars($uuid) ?>">
                    <div class="mb-3">
                        <div class="feedback">
                            <div class="rating">
